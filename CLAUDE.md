...
./scripts/gates-have-teeth.sh        # 96 cases; needs a clean tree; @measured 2026-09-03, 95 passed 0 failed on four separate runs (5m50s, 6m23s and 6m33s), the last after the Value/PrevValue fix retargeted one case
