...
C4 (this file's own invariant 34, rebased past B4 step two's merge, which
had already taken 33) moved 567 -> 593 tests (connectors gained 6 for the
...
73 -> 76 gates-have-teeth.sh cases (one per named mutant: floats in
coverage, a Purchase row counted as usage, purchase in the apply table).
Feature scenarios 126 -> 130.
...
34. **A Purchase row is never usage, and a commitment's coverage and
